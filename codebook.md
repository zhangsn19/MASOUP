...
| **Experience towards designs' features** | **Visual encoding** | Experiences around visual encoding, which utilize color temperature and opacity to direct user focus toward risks. |
